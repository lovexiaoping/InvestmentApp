...
// YLTextView
#define COCOAPODS_POD_AVAILABLE_YLTextView
#define COCOAPODS_VERSION_MAJOR_YLTextView 0
#define COCOAPODS_VERSION_MINOR_YLTextView 2
#define COCOAPODS_VERSION_PATCH_YLTextView 0
